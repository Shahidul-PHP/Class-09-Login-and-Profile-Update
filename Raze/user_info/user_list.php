...
$view_info = "SELECT * FROM students";
$view_info_result = mysqli_query($db_connection, $view_info);
?>
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="../admin_assets/admin_files/images/favicon.png">
    <link rel="stylesheet" href="../admin_assets/admin_files/vendor/chartist/css/chartist.min.css">
    <link href="../admin_assets/admin_files/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link href="../admin_assets/admin_files/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="../admin_assets/admin_files/css/style.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="../admin_assets/admin_files/images/logo.png" alt="">
                <img class="logo-compact" src="../admin_assets/admin_files/images/logo-text.png" alt="">
                <img class="brand-title" src="../admin_assets/admin_files/images/logo-text.png" alt="">
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                Oxford University Student panel
                            </div>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <?php foreach ($view_info_result as $users) { ?>
                                            <tr>
                                                <td><?= $users['id'] ?></td>
                                                <td><?= $users['name'] ?></td>
                                                <td><?= $users['roll'] ?></td>
                                                <td><?= $users['email'] ?></td>
                                                <td>
                                                    <a href="edit_user.php?id=<?= $users['id'] ?>" class="btn btn-warning text-white"><i class="fa-solid fa-user-pen"></i></a>

                                                    <button data-id="delete_user.php?id=<?= $users['id'] ?>" class="delete_btn btn btn-primary"><i class=" fa-sharp fa-solid fa-trash"></i></button>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </table>
